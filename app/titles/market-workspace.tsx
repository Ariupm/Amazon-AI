...
const REQUIRED_BACKEND = "hundred-competitor-candidates-v14";
    ...
    <div className="marketShell">
      ...
      <section className="marketContent">
        ...
        <article className="panel discoverPanel" id="competitor-discovery">
          ...
          {searchPlan && <label className="candidateLimitToggle"><input type="checkbox" checked={resultLimit === 100} onChange={event => setResultLimit(event.target.checked ? 100 : 60)} />扩充候选上限至 100 个（关闭时恢复 60 个）</label>}
